...
def dealcontent(input_str):
    input_str = input_str.replace("<br />", "\n")
    input_str = removetag(input_str, "a")
    input_str = removetag(input_str, "div")
    input_str = removetag(input_str, "img")
    input_str = removetag(input_str, "span")
...
print("Page Count = " + str(last_page_num))
...
for i in range(last_page_num):
    ...
    print("Count = " + str(len(posts_div_list)))
